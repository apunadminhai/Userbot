...
async def carbon_api(e):
    ...
    CARBON = 'https://carbon.now.sh/?bg=rgba(0%252C132%252C253%252C1)&t=twilight&wt=sharp&l=auto&ds=true&dsyoff=20px&dsblur=0px&wc=true&wa=true&pv=62px&ph=64px&ln=false&fl=1&fm=Hack&fs=14.5px&lh=139%2525&si=false&es=4x&wm=false&code='
    global CARBONLANG
